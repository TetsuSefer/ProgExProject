...
public class Account {
    ...
    private String password = "denizdeniz";
    ...
    public int addAccountAndUser(String username, String password, String fullName, String email) {
        try (Connection connection = DriverManager.getConnection(url, this.username, this.password);
             PreparedStatement accountStatement = connection.prepareStatement("INSERT INTO accounts (username, password) VALUES (?, ?)", Statement.RETURN_GENERATED_KEYS);
             PreparedStatement userStatement = connection.prepareStatement("INSERT INTO users (full_name, email) VALUES (?, ?)")) {
